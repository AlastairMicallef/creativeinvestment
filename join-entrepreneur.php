        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-10 align-self-end">
                    <h1 class="text-uppercase text-white font-weight-bold">Choose your Sector(s)</h1>
                </div>
                                ...
                                <div data-toggle="buttons" class="btn-group bizmoduleselect">
                                    <label class="btn btn-default">
                                        <div class="bizcontent">
                                            ...
                                            <h5>retail and wholesale trade</h5>
                                        </div>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div data-toggle="buttons" class="btn-group bizmoduleselect">
                                    <label class="btn btn-default">
                                        <div class="bizcontent">
                                            <input type="checkbox" name="var_id[]" autocomplete="off" value="">
                                            <span class="glyphicon glyphicon-ok glyphicon-lg"></span>
                                            <h5>Professional, scientific, technical services</h5>
                                        </div>
                                    </label>
                                </div>
                            </div>
                                    ...
                                    <div data-toggle="buttons" class="btn-group bizmoduleselect">
                                        <label class="btn btn-default">
                                            <div class="bizcontent">
                                                <input type="checkbox" name="var_id[]" autocomplete="off" value="">
                                                <span class="glyphicon glyphicon-ok glyphicon-lg"></span>
                                                <h5>Arts, entertainment and recreation</h5>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div data-toggle="buttons" class="btn-group bizmoduleselect">
                                        <label class="btn btn-default">
                                            <div class="bizcontent">
                                                <input type="checkbox" name="var_id[]" autocomplete="off" value="">
                                                <span class="glyphicon glyphicon-ok glyphicon-lg"></span>
                                                <h5>Transportation, warehousing</h5>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div data-toggle="buttons" class="btn-group bizmoduleselect">
                                        <label class="btn btn-default">
                                            <div class="bizcontent">
                                                <input type="checkbox" name="var_id[]" autocomplete="off" value="">
                                                <span class="glyphicon glyphicon-ok glyphicon-lg"></span>
                                                <h5>Manufacturing, agriculture, mining</h5>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div data-toggle="buttons" class="btn-group bizmoduleselect">
                                        <label class="btn btn-default">
                                            <div class="bizcontent">
                                                <input type="checkbox" name="var_id[]" autocomplete="off" value="">
                                                <span class="glyphicon glyphicon-ok glyphicon-lg"></span>
                                                <h5>Accomodations, food services</h5>
                                            </div>
                                        </label>
                                    </div>
                                </div>
            ...
            <a class="btn btn-primary btn-lg" href="entre-details.php" role="button">Confirm Selection</a>
